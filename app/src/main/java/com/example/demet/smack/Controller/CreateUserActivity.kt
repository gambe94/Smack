...
import com.example.demet.smack.Services.UserDataService
import com.example.demet.smack.Utilities.BROADCAST_USER_DATA_CHANGED
import kotlinx.android.synthetic.main.activity_create_user.*
import java.util.*

class CreateUserActivity : AppCompatActivity() {

    var userAvatar = "profilDefault"
    ...
    fun errorToast(){
        Toast.makeText(this, "Something went worg try it again", Toast.LENGTH_SHORT).show()
        enableSpinner(false)
    }
